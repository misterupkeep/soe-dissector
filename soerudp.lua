...
-- SOE_DATA_FRAG_A --
---------------------
-- ACKs are sent to fragments "every once in a while", it seems.
fragment_total_size = ProtoField.uint32("soe.fragment_total_size", "fragmentTotalSize", base.DEC)

-------------------------------------
-- SOE_ACK_A / SOE_OUT_ORDER_PKT_A --
-------------------------------------
-- These two share layouts
crc_footer = ProtoField.bytes("soe.crc_footer", "crcFooter")

-------------------
-- SOE_MULTI_SOE --
-------------------
-- payload_size, char payload[payload_size] until EOF
...
soe_protocol.fields = {
    ...
    fragment_total_size, -- Fragmented Data
